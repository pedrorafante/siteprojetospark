...
const adicionarTarefa = () =>{
    ...
    //adiciona ao bloco novoContainer, já com a tarefa e ícone dentro do bloco destinado.
    ...
    valorInput.focus()
        ...
        select.addEventListener("change", function() {
            ...
            const tarefaConcluida = document.querySelectorAll('.concluida')
            const tarefaPendente = document.querySelectorAll('.novoContainer')
